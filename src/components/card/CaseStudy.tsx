...
import useBreakpointCharLimit from "@/src/@core/hooks/useBreakpointCharLimit";
      ...
      <div className="flex gap-2 py-[1rem]">
        {labels?.map((label: any, idx: number) => {
          return (
            <span
              key={idx}
              className="rounded-full bg-[#FFFFFF] px-[1rem] py-[0.25rem] text-[12px] uppercase text-[#000000]"
            >
