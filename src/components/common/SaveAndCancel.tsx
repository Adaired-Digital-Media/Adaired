  ...
  return (
    <div className={`${className} flex gap-2 lg:gap-4`}>
      <button
        ...
        onClick={handleClick}
        className={`${widthClass} font-Outfi flex w-full cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-[60px] py-[0.75rem] px-6 text-xxs font-normal transition-all duration-300 ease-out active:scale-95 xl:text-xs 1366:text-[14px] 1400:text-[18px] 1470:text-[18px] 1600:text-[18px] 1680:text-[18px] ${
          isBgWhite
            ? isHover
