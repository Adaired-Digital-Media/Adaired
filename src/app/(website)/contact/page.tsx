        ...
        <div className="py-12">
          <MaxWidthWrapper>
            <div className="grid grid-cols-1 gap-20 md:grid-cols-3 md:gap-6">
              <div className="relative rounded-xl border bg-white p-6 pt-16 text-center">
              ...
              <div className="relative rounded-xl border bg-white p-6 pt-16 text-center">
                ...
                <Link
                  ...
                  className="block font-semibold text-[#051320]"
                >
                  +91-89072 00008
                </Link>
                <Link
              ...
              <div className="relative rounded-xl border bg-white p-6 pt-16 text-center">
                ...
                >
                  ...
                  <span className="text-[#051320]">info@adaired.com</span>
                </Link>
                <Link
                ...
                >
                  ...
                  <span className="text-[#051320]">hr@adaired.com</span>
                </Link>
              </div>
            </div>
          </MaxWidthWrapper>
